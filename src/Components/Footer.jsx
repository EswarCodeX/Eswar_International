  ...
  return (
    <>
      <div className="w-full h-full bg-[#112D4E] font-sans  ">
        <div className="pt-12 pl-32 gap-48 flex pb-14">
          <div className="w-[20%] ">
            <div className="text-[#F9F7F7] text-2xl font-bold">
              ESWAR INTERNATION
            </div>
          ...
          <div className="text-[#F9F7F7] text-3xl font-bold">
            ...
            <div>
              {servicesopen && (
                <div className="  text-white/70 text-xl font-medium pl-4 pb-2  ">
                  <div className="pb-1">Vegitables</div>
                  <div>Garland</div>
                </div>
              )}
            </div>
            <div className="pb-2">Contact</div>
            <div className="pb-2">Coming Soon</div>
          </div>
          <div className="text-[#F9F7F7]">
